...
class WelcomeScreen {
	...
	private lowgraphics: HTMLInputElement;

	onLogin: (nickname: string, hideNames: boolean, lowGraphics: boolean) => void;
	...
	private addEventListeners() {
		...
		this.lowgraphics = <HTMLInputElement>this.element.getElementsByClassName('lowgraphics')[0];
		...
		let buttonAction = (ev: Event) => {
			...
			this.onLogin(this.nickname.value, this.hidenames.checked, this.lowgraphics.checked);
